    ...
    <div class="modal-dialog" >
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="../NiceAdmin/DB/brand/<?php echo $id_modifi > 0?'modifi.php':'add.php' ?>"
              ...
              <div class="form-horizontal">
                ...
                <div class="form-group">
                  <div class="row mb-3">
                    <label for="mota" class="control-label col-md-2 text-right">Description</label>
                    <div class="col-md-10">
                      <input type="text" name="mota" class="form-control" value="<?php echo $dataOne['Mota']??'' ?>">
                    </div>
                  </div>
                </div>
                <div class="form-group">
